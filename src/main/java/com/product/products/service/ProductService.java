...
public class ProductService {
    ...
    public List<ApprovalQueueEntity> getAllProductFromApprovalQueue(){
    	Comparator<ApprovalQueueEntity> appvCom=(app1,app2)->app2.getApprovalQueueId()-app1.getApprovalQueueId();
       return  approvalQueueRepository.findAll().stream().sorted(appvCom).collect(Collectors.toList()); 		
    }
